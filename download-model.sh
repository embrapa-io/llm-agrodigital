...
#   ./download-model.sh Qwen/Qwen3-VL-4B-Instruct /data/models/meu-modelo
#
...
REPO_ID="${REPO_ID:-cyankiwi/Qwen3-VL-8B-Instruct-AWQ-4bit}"

TARGET_DIR="${2:-$(get_env SGLANG_MODEL_PATH)}"
TARGET_DIR="${TARGET_DIR:-/data/models/qwen3-vl-8b-instruct-awq}"
